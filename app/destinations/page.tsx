...
export default function DestinationsPage() {
  const eastAfrica = destinations.filter((d) => d.region === 'East Africa');
  ...
  const featured = eastAfrica[0]; // Rwanda
    ...
    <main className="bg-white">
      ...
      <section className="px-6 py-24 lg:px-10 lg:py-32">
        <div className="mx-auto max-w-[1280px] space-y-12">
          ...
          {/* East Africa — remaining 3 countries */}
        ...
        <div className="mx-auto max-w-[1280px] space-y-12">
          ...
          >
            <div className="space-y-4">
              ...
              <h2 className="text-balance text-[clamp(2.2rem,4.6vw,3.6rem)] leading-tight tracking-[-0.025em] text-neutral-950">
                <span className="font-bold">Beyond</span> <span className="font-light">East Africa</span>
              </h2>
            </div>
            <div className="flex items-center gap-6 text-[0.65rem] font-medium uppercase tracking-[0.4em] text-neutral-500">
